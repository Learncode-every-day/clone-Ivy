...
function showMyCartInAbate() {
    ...
    for (let i = 0; i < cart.length; i++) {
        ...
        if (price__current_full > 999 && price__current_full < 10000) {
            ...
            var price__current_full_full_string1 =
                price__current_full_string1.slice(0, 1) +
                "." +
                price__current_full_string1.slice(1);
            ...
            var price__current_full_full_string2 =
                price__current_full_string2.slice(0, 2) +
                "." +
                price__current_full_string2.slice(2);
            price__current_full = price__current_full_full_string2;
        } else if (
            price__current_full > 99999 &&
            price__current_full < 1000000
        ) {
            var price__current_full_string3 = price__current_full.toString();
            var price__current_full_full_string3 =
                price__current_full_string3.slice(0, 3) +
                "." +
                price__current_full_string3.slice(3);
        ...
        if (cost > 999 && cost < 10000) {
            ...
            var cost_full_string1 =
                cost_string1.slice(0, 1) + "." + cost_string1.slice(1);
            cost = cost_full_string1;
        } else if (cost > 9999 && cost < 100000) {
            var cost_string2 = cost.toString();
            var cost_full_string2 =
                cost_string2.slice(0, 2) + "." + cost_string2.slice(2);
            cost = cost_full_string2;
        } else if (cost > 99999 && cost < 1000000) {
            var cost_string3 = cost.toString();
            var cost_full_string3 =
                cost_string3.slice(0, 3) + "." + cost_string3.slice(3);
    ...
    if (sum > 999 && sum < 10000) {
        ...
        var sum_full_string1 =
            sum_string1.slice(0, 1) + "." + sum_string1.slice(1);
        sum = sum_full_string1;
    } else if (sum > 9999 && sum < 100000) {
        var sum_string2 = sum.toString();
        var sum_full_string2 =
            sum_string2.slice(0, 2) + "." + sum_string2.slice(2);
        sum = sum_full_string2;
    } else if (sum > 99999 && sum < 1000000) {
        var sum_string3 = sum.toString();
        var sum_full_string3 =
            sum_string3.slice(0, 3) + "." + sum_string3.slice(3);
